            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
						<span>
                            <a href="<?php echo base_url(); ?>user/profile/<?php echo $this->session->userdata("user_id") ?>"><img alt="image" class="img-circle avatar_left" src="<?php echo base_url(); echo $this->session->userdata("user_avatar"); ?>"  onerror="this.onerror=null;this.src='<?php echo base_url()?>/images/avatar.png';" /></a>
                        </span>
               ...
               <!--  <li>
                    <a href="<?php echo base_url() ?>admin/manage_users_access"><i class="fa fa-eye"></i> <span class="nav-label">Manage Users Access</span></a>
                </li> -->
                <li>
                ...
                <li>
                    <a href="<?php echo base_url() ?>admin/app_links"><i class="fa fa-tablet"></i> <span class="nav-label">App Links</span></a>
                </li>
				                <li>
                    <a href="<?php echo base_url() ?>admin/customers"><i class="fa fa-commenting"></i> <span class="nav-label">OkDate Customers</span></a>
                </li>
