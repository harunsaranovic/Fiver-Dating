...
<div class="col-lg-12 block_form">
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="col-md-4">
			<div class="well block_admin_dash">
				<a href="<?php echo base_url(); ?>admin/chatroom"><i class="fa fa-comments"></i></a>
				<div class="desc_admin_block">
					<a href="<?php echo base_url(); ?>admin/chatroom">Manage Chatroom</a>
				</div>
			</div>
		</div>
		<div class="col-md-4">
	...
	<!-- <div class="row">
		<div class="col-md-4">
			<div class="well block_admin_dash">
				<a href="<?php echo base_url(); ?>admin/manage_users_access"><i class="fa fa-eye"></i></a>
				<div class="desc_admin_block">
