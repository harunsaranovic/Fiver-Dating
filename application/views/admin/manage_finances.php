...
<div class="col-lg-12 block_form">
	...
	<form action="" method="post" accept-charset="utf-8" class="general_config well">
        ...
        <div class="payment_checked <?php if($settings["enable_payments"] == 1) { echo "show"; } ?>">
	        ...
	        <fieldset>
	        	<legend><i class="fa fa-cc-paygol"></i> Stripe Settings</legend>
	        	<div class="alert alert-info alert-centered">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control stripe_pub_key" id="stripe_pub_key" name="stripe_pub_key" value="<?php echo $settings["stripe_pub_key"]; ?>" placeholder="Get your API Publishable Key on Stripe.com">
				        	...
				        	<legend>Paygol Settings</legend>
	        	<div class="alert alert-info alert-centered">
					If you set the Paygol API keys blanked, Paygol will not be enabled.
				</div> 
				<div class="form-group">
					<label for="paygol_service_id">Secret Id :</label>
					<input type="text" class="form-control paygol_service_id" id="paygol_service_id" name="paygol_service_id" value="<?php echo $settings["paygol_service_id"]; ?>" placeholder="Get your Secret ID on Paygol">
				</div>
				<div class="form-group">
					<label for="paygol_service_name">Service Name :</label>
					<input type="text" class="form-control paygol_service_name" id="paygol_service_name" name="paygol_service_name" value="<?php echo $settings["paygol_service_name"]; ?>" placeholder="Get your Secret Name on Paygol">
				</div>
	        </fieldset>
	        ...
	        <fieldset>
				...
				<div class="form-group">
					<label for="spot_light_price">Spot Light Coins Price:</label>
					<input type="text" class="form-control spot_light_price" id="spot_light_price" name="spot_light_price" value="<?php echo $settings["spot_light_price"]; ?>" placeholder="Set the Coins Value">
				</div>
				<div class="form-group">
					<label for="active_message_price">Active Message To Friend Coins Price:</label>
					<input type="text" class="form-control active_message_price" id="active_message_price" name="active_message_price" value="<?php echo $settings["active_message_price"]; ?>" placeholder="Set the Coins Value">
				</div>
				<div class="form-group">
