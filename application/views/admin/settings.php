...
<div class="col-lg-12 block_form">
	...
	<form action="" method="post" accept-charset="utf-8" class="general_config well">
		...
		<hr />
		<fieldset>
			<legend><i class="fa fa-envelope"></i> E-mail Settings</legend>
			<div class="form-group">
				<label for="from_email">From E-mail Address :</label>
				<input type="text" class="form-control from_email" id="from_email" name="from_email" value="<?php echo $settings["from_email"]; ?>" placeholder="e.g noreply@example.com">
			</div>
		</fieldset>
		<hr />
