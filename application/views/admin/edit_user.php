		...
		<div class="panel panel-success">
			...
			<div id="collapsePhotos" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingPhotos">
				<div id="photosBody" class="panel-body">
					...
					<div class="alert alert-info">No photos uploaded so far.</div>
					<?php } else { ?>
						<div class="lightBoxGallery" id="galleryItems">
							<?php foreach ($photos as $photo) { ?>
								<div class="galleryItem">
									<div style="position: relative;">
										<img class="img-thumbnail" data-id="<?php echo $photo["id"] ?>" src="<?php echo base_url() . $photo["url"] ?>" style="cursor: pointer;" />
									</div>
								</div>
							<?php } ?>
						</div>
