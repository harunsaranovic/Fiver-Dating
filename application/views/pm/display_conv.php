		...
		<div class="main_container clearfix">
		    <div class="ibox-content-no-bg">
				...
				<div class="chat-message-form">
					...
					?>
						<a class="btn btn-primary btn-msgdisabled" href="#" data-user-id="<?php echo $user["uid"]; ?>" data-conv-id="<?php echo $current_conv->id; ?>"><?php echo $this->lang->line("send_reply_btn"); ?></a>
					<?php
					}
					?>
								</div>
