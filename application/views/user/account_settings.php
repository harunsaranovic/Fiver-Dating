    ...
    <div class="row">
	    ...
	    <div class="main_container">
			...
			<div class="panel-group panel-settings" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-default" id="addPhotos">
				...
				<div class="panel panel-info">
					...
					<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="panel-body">
							<form action="<?php echo base_url() ?>user/edit_account_submit" method="POST" class="form-horizontal form-edit-account-infos col-md-8 col-md-offset-2">
								<div class="form-group">
								...
								<div style="text-align:center;">
									<button class="btn  btn-primary  btn-finish-edit-account">
				...
				<div class="panel panel-warning">
					<div class="panel-heading" role="tab" id="resetpassword_tab">
						<h4 class="panel-title">
						<a class="resetpassword" data-toggle="collapse" data-parent="#accordion" href="#resetpassword" aria-expanded="false" aria-controls="collapseThree">
						<?php echo $this->lang->line("reset_password"); ?> </a>
						</h4>
					</div>
					<div id="resetpassword" class="panel-collapse collapse" role="tabpanel" aria-labelledby="resetpassword_tab">
						<div class="panel-body">
							<form action="<?php echo base_url() ?>user/reset_password_submit" method="POST" class="form-horizontal form-edit-account-password col-md-8 col-md-offset-2">
								<div class="form-group">
									<label class="control-label"><?php echo $this->lang->line("old_password"); ?></label>
									<input type="password" class="form-control username" name="old_password" placeholder="<?php echo $this->lang->line("old_password"); ?>" value="" />
								</div>
								<div class="form-group">
									<label class="control-label"><?php echo $this->lang->line("new_password"); ?></label>
									<input type="password" class="form-control email" name="new_password" placeholder="<?php echo $this->lang->line("new_password"); ?>" value="" />
								</div>
								<div class="form-group">
									<label class="control-label"><?php echo $this->lang->line("new_confrom_password"); ?></label>
									<input type="password" class="form-control email" name="confirm_password" placeholder="<?php echo $this->lang->line("new_confrom_password"); ?>" value="" />
								</div>
								<hr style="margin-top:20px !important;">
								<div class="error-account-infos alert alert-danger">
								</div>
								<div style="text-align:center;">
									<button class="btn  btn-primary  btn-finish-edit-account-infos">
										<i class="fa fa-pencil"></i> <?php echo $this->lang->line("save"); ?>
									</button>
								</div>
							</form>
						</div>
