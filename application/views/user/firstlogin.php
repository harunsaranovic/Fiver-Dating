...
<div class="container">
	...
	<div class="row">
		<div class="pull-left">
			<h3 style="color: black"><?php echo $this->lang->line('account_informations'); ?></h3>
		</div>
	</div>
	<div class="row">
	    <?php
		    ...
		    <div class="ibox-content">
				<form action="<?php echo base_url() ?>user/firstloginsubmit" method="POST" class="edit_form first_login_form form-horizontal" enctype='multipart/form-data'>
		            <div class="form-group birthday_group"><label class="col-sm-2 control-label"  ><?php echo $this->lang->line('Birthday'); ?></label>
		                ...
		                <div class="col-sm-8 col-dm-offset-2">
		                    <div class="col-md-4">
		            ...
		            <div class="form-group"><label class="col-sm-2 control-label" ><?php echo $this->lang->line('about_you'); ?></label>
		                <div class="col-sm-8 col-xs-12"><textarea class="form-control about_you_txt" name="about_you_txt" placeholder="<?php echo $this->lang->line('about_you_placeholder'); ?>"></textarea> <span class="text-warning" style="color:#CCC !important"><i><?php echo $this->lang->line('about_you_info'); ?></i></span>
		                </div>
		            </div>
		            <?php
		            ...
		            <div class="form-group"><label class="col-lg-2 control-label" ><?php echo $this->lang->line('city'); ?></label>
		                <div class="col-lg-8"><input type="text" id="cityform" placeholder="<?php echo $this->lang->line('city_placeholder'); ?>" name="city" class="form-control"><span class="text-warning" style="color:#CCC !important"><i><?php echo $this->lang->line('Optional'); ?></i></span></div>
		            </div>
					<div class="hr-line-dashed"></div>
