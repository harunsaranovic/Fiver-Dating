			...
			<div class="premium_features_list">
				...
				<div class="well premium_feature">
					...
					<div class="row">
						...
						<div class="pf_desc col-md-8">
							<h4><?php echo $this->lang->line("spotlight_title"); ?> <span class="price_desk_premium">• <span class="badge badge-danger badge-premium-price"><?= $settings['spot_light_price'];?> Coins</span></span></h4>
							<span class="badge badge-danger badge-mob-price"><?= $settings['spot_light_price'];?> Coins</span>
							<p>
								<?php echo sprintf($this->lang->line("spotlight_desc"), $settings["site_name"]); ?>
							</p>
						</div>
						<div class="pf_take_it col-md-2">
							<?php
							if($spotlight_purchased):
							?>
							<a class="btn btn-success disabled">
								<i class="fa fa-check"></i> <?php echo $this->lang->line("purchased_btn"); ?>
							</a>
							<?php else: ?>
							<a class="btn btn-danger btn-take" data-name="spot_light">
								<i class="fa fa-diamond"></i> <?php echo $this->lang->line("take_it_btn"); ?>
							</a>
							<?php
							endif;
					...
					<div class="row">
						...
						<div class="pf_desc col-md-8">
							<h4><?php echo $this->lang->line("active_message_title"); ?> <span class="price_desk_premium">&bullet; <span class="badge badge-danger badge-premium-price"><?php echo sprintf($this->lang->line("feature_price"), $settings["active_message_price"]); ?></span></span></h4>
							<span class="badge badge-danger badge-mob-price"><?php echo sprintf($this->lang->line("feature_price"), $settings["active_message_price"]); ?></span>
							<p>
								<?php echo sprintf($this->lang->line("active_message_desc"), $settings["site_name"]); ?>
							</p>
						</div>
						<div class="pf_take_it col-md-2">
							<?php
							...
							<?php else: ?>
							<a class="btn btn-danger btn-take" data-name="active_message">
								<i class="fa fa-diamond"></i> <?php echo $this->lang->line("take_it_btn"); ?>
							</a>
							<?php
							endif;
