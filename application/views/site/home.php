...
$spotlight['spotlight_purchased']=$spotlight_purchased;
$spotlight['spotlight_users']    =$spotlight_users;
$this->load->view('site/spotlight',$spotlight, FALSE);
endif;
?>
<div class="container " >
	<?php
   ...
   <div class="row">
        ...
        <?php /*?><div class="pull-right" style="margin:0px 5px !important">
			<a class="btn btn-primary filters " href="<?php echo base_url(); ?>premium">
	...
	<div class="row">
		...
		if(isset($_GET["action"])) {
			...
			<?php
			} else if($_GET["action"] == "no_encounters_found") {
			?>
			<div class="alert alert-success" style="text-align:center;margin-top: 10px;">
				<?php echo $this->lang->line('no_encounter'); ?>
			</div>
						<?php
			} else if($_GET["action"] == "no_matches_found") {
			?>
			<div class="alert alert-success" style="text-align:center;margin-top: 10px;">
				<?php echo $this->lang->line('no_matches'); ?>
			</div>
			<?php
			}
		}
		...
		<div class="main_container">
			...
			if($this->session->userdata('filter_age_from'))
	        {
		        ...
		        $age_to		= intval($this->session->userdata('filter_age_to'));
						...
						if($this->session->userdata('filter_country') == "0")
			             $country = "Everywhere";
					 else
...
<div class="modal fade" id="noencounter">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		$('body').on('click', '.dropdown-avatar', function(event) {
