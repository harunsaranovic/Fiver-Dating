		    ...
		    <div class="ibox-content-no-bg">
				...
				<div class="media" id="replybox">
					<div class="media-body answer-block-forum">
						...
						<textarea name="content" required="required" id="inputDesc" class="form-control forum-content-reply-txt forum-ta" rows="4" placeholder="<?php echo $this->lang->line("send_answer_placeholder"); ?>"></textarea>
