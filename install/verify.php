...
if(isset($_POST['purchase_code'])){
    ...
    if ( is_object($o) ) {
      ...
      $output_table .= '</tbody>';
	  echo '<script type="text/javascript">M.toast({html: "License Valid!"});</script><br><a href="installer.php" class="waves-effect waves-light btn-large">Go to Installer</a></div>';
      ...
      echo "<script>M.toast({html: 'Sorry, This is not a valid purchase code or this user have not purchased any of your items!'})</script>";
    }
}
?>