$(document).ready(function() {
	$('.thumbnail').nailthumb();	
    //new js add by sakhideveloper@gmail.com

     
     $(".response_like").click(function(e) {
		e.preventDefault();
		var profile_id = $(this).attr("data-id");
		var that = $(this).parent();
		$.ajax({
			url: base_url + "user/post_like",
			type: 'POST',
	...
	$(".response_unlike").click(function(e) {
		e.preventDefault();
